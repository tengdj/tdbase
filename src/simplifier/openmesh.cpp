...
class Constrained_edge_map {
  public:
    ...
    Constrained_edge_map(Surface_mesh& sm) : sm_(sm) {
...
int main(int argc, char** argv) {
    ...
    int r = SMS::edge_collapse(
        surface_mesh, stop,
        CGAL::parameters::halfedge_index_map(get(CGAL::halfedge_index, surface_mesh)).vertex_point_map(get(boost::vertex_point, surface_mesh)));
