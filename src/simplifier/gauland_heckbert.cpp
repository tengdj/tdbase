...
template <typename GHPolicies> void collapse_gh(Surface_mesh& mesh, const double ratio) {
...
int main(int argc, char** argv) {
    ...
    std::cout << "Input mesh has " << num_vertices(mesh) << " nv " << num_edges(mesh) << " ne " << num_faces(mesh) << " nf" << std::endl;
