...
inline void VdS(float Vr[3], const float V[3], float s) {
    assert(s > 0);
    Vr[0] = V[0] / s;
    Vr[1] = V[1] / s;
    Vr[2] = V[2] / s;
...
result_container
MeshDist(const float* data1, const float* data2, size_t size1, size_t size2, const float* hausdorff1 = NULL, const float* hausdorff2 = NULL);
...
result_container
MeshInt(const float* data1, const float* data2, size_t size1, size_t size2, const float* hausdorff1 = NULL, const float* hausdorff2 = NULL);
