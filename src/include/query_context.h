...
class query_context {
  public:
    ...
    void report(double t) {
        ...
        cerr << "other:\t" << t * (overall_time - index_time - decode_time - packing_time - computation_time - updatelist_time) / overall_time << endl
             << endl;
        ...
        fprintf(stderr, "%f\t%f\t%f\t%f\t%f\t%f\t%f\n", t * index_time / overall_time, t * decode_time / overall_time,
                t * packing_time / overall_time, t * computation_time / overall_time, t * updatelist_time / overall_time,
                t * (overall_time - index_time - decode_time - packing_time - computation_time - updatelist_time) / overall_time, t);
    }
};
