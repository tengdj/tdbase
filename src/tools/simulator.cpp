...
int main(int argc, char** argv) {
    ...
    auto allow_intersection_option =
        op.add<Switch>("i", "allow_intersection", "allow the nuclei to intersect with other nuclei or vessel", &allow_intersection);
    ...
    char config[100];
    sprintf(config, "nv%d_nu%d_vs%d_r%d", num_vessel, num_nuclei_per_vessel, voxel_size, HiMesh::sampling_rate);
